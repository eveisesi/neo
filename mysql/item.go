...
func (r *killmailItemRepository) ByKillmailID(ctx context.Context, id uint) ([]*neo.KillmailItem, error) {
...
func (r *killmailItemRepository) ByKillmailIDs(ctx context.Context, ids []uint) ([]*neo.KillmailItem, error) {
