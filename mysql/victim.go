...
func (r *killmailVictimRepository) ByKillmailID(ctx context.Context, id uint) (*neo.KillmailVictim, error) {
...
func (r *killmailVictimRepository) ByKillmailIDs(ctx context.Context, ids []uint) ([]*neo.KillmailVictim, error) {
