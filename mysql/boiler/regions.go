...
type Region struct {
	...
	FactionID null.Int  `boil:"faction_id" json:"factionID,omitempty" toml:"factionID" yaml:"factionID,omitempty"`
...
var RegionWhere = struct {
	...
	ID:        whereHelperint64{field: "`regions`.`id`"},
	...
	PosZ:      whereHelperfloat64{field: "`regions`.`pos_z`"},
	FactionID: whereHelpernull_Int{field: "`regions`.`faction_id`"},
...
var (
	regionAllColumns            = []string{"id", "name", "pos_x", "pos_y", "pos_z", "faction_id", "created_at", "updated_at"}
	regionColumnsWithoutDefault = []string{"id", "name", "pos_x", "pos_y", "pos_z", "faction_id", "created_at", "updated_at"}
...
func (q regionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Region, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for regions")
	}
...
func (q regionQuery) All(ctx context.Context, exec boil.ContextExecutor) (RegionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Region slice")
	}
...
func (q regionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count regions rows")
	}
...
func (q regionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if regions exists")
	}
...
func FindRegion(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Region, error) {
	regionObj := &Region{}
	...
	query := fmt.Sprintf(
		"select %s from `regions` where `id`=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from regions")
	}
...
func (o *Region) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no regions provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO `regions` () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT `%s` FROM `regions` WHERE %s", strings.Join(returnColumns, "`,`"), strmangle.WhereClause("`", "`", 0, regionPrimaryKeyColumns))
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into regions")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to populate default values for regions")
	}
...
func (o *Region) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update regions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update regions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for regions")
	}
...
func (q regionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for regions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for regions")
	}
...
func (o RegionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in region slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all region")
	}
	return rowsAff, nil
}

var mySQLRegionUniqueColumns = []string{
	"id",
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *Region) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no regions provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	nzDefaults := queries.NonZeroDefaultSet(regionColumnsWithDefault, o)
	nzUniques := queries.NonZeroDefaultSet(mySQLRegionUniqueColumns, o)
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("boiler: unable to upsert regions, could not build update column list")
		}

		ret = strmangle.SetComplement(ret, nzUniques)
		cache.query = buildUpsertQueryMySQL(dialect, "regions", update, insert)
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `regions` WHERE %s",
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert for regions")
	}
	...
	uniqueMap, err = queries.BindMapping(regionType, regionMapping, nzUniques)
	if err != nil {
		return errors.Wrap(err, "boiler: unable to retrieve unique values for regions")
	}
...
func (o *Region) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Region provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from regions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for regions")
	}
...
func (q regionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no regionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from regions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for regions")
	}
...
func (o RegionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from region slice")
	}
...
func (o *RegionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in RegionSlice")
	}
...
func RegionExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if regions exists")
	}
