...
var RegionWhere = struct {
	...
	FactionID: whereHelpernull_Uint{field: "`regions`.`faction_id`"},
...
func (o *Region) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns, ignore bool) error {
	if o == nil {
