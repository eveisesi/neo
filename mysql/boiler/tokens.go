...
var TokenWhere = struct {
	...
	DisabledReason    whereHelperstring
	CreatedAt         whereHelpertime_Time
	UpdatedAt         whereHelpertime_Time
}{
	ID:                whereHelperuint64{field: "`tokens`.`id`"},
	Main:              whereHelperuint64{field: "`tokens`.`main`"},
	AccessToken:       whereHelperstring{field: "`tokens`.`access_token`"},
	RefreshToken:      whereHelperstring{field: "`tokens`.`refresh_token`"},
	Expiry:            whereHelpertime_Time{field: "`tokens`.`expiry`"},
	Disabled:          whereHelperbool{field: "`tokens`.`disabled`"},
	DisabledTimestamp: whereHelpernull_Time{field: "`tokens`.`disabled_timestamp`"},
	DisabledReason:    whereHelperstring{field: "`tokens`.`disabled_reason`"},
...
var (
	tokenAllColumns            = []string{"id", "main", "access_token", "refresh_token", "expiry", "disabled", "disabled_timestamp", "disabled_reason", "created_at", "updated_at"}
	tokenColumnsWithoutDefault = []string{"id", "main", "access_token", "refresh_token", "expiry", "disabled_timestamp", "disabled_reason", "created_at", "updated_at"}
	tokenColumnsWithDefault    = []string{"disabled"}
...
func (q tokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Token, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for tokens")
	}
...
func (q tokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (TokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Token slice")
	}
...
func (q tokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count tokens rows")
	}
...
func (q tokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if tokens exists")
	}
...
func FindToken(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Token, error) {
	tokenObj := &Token{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from tokens")
	}
...
func (o *Token) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns, ignore bool) error {
	if o == nil {
		return errors.New("boiler: no tokens provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("%s INTO `tokens` (`%s`) %%sVALUES (%s)%%s", insert, strings.Join(wl, "`,`"), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = fmt.Sprintf("%s INTO `tokens` () VALUES ()%s%s", insert)
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into tokens")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to populate default values for tokens")
	}
...
func (o *Token) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update tokens, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update tokens row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for tokens")
	}
...
func (q tokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for tokens")
	}
...
func (o TokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in token slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all token")
	}
	return rowsAff, nil
}
...
func (o *Token) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no tokens provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("boiler: unable to upsert tokens, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert for tokens")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to retrieve unique values for tokens")
	}
...
func (o *Token) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Token provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for tokens")
	}
...
func (q tokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no tokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for tokens")
	}
...
func (o TokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from token slice")
	}
...
func (o *TokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in TokenSlice")
	}
...
func TokenExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if tokens exists")
	}
